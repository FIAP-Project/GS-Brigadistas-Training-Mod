...
public class BDTBlockEntities {
    ...
    public static final RegistryEntry<BlockEntityType<InfoOverlayBlockEntity>> INFO_OVERLAY_BLOCK_ENTITY = BLOCK_ENTITIES.register(
            ...
            () -> BlockEntityType.Builder
                    .of(InfoOverlayBlockEntity::new, BDTBlocks.FOGUEIRA_MAL_APAGADA.get(), BDTBlocks.POSTE.get(), BDTBlocks.GARRAFAS_QUEBRADAS.get(), BDTBlocks.BITUCA_DE_CIGARRO.get(), BDTBlocks.FIRE_EXTINGUISHER.get())
                    .build(null)
    );
